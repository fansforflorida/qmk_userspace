...
enum custom_keycodes {
    CD_HOME = SAFE_RANGE,
    RM_TEST, // TODO This is just for testing
};

// TODO This is just for testing
const uint8_t rgb_matrix_split[2] = RGB_MATRIX_SPLIT;
uint8_t led_index = rgb_matrix_split[0];
    ...
    switch (keycode) {
        ...
        case RM_TOGG:
            if (record->event.pressed) {
                ...
                case (LED_FLAG_UNDERGLOW | LED_FLAG_KEYLIGHT):
                ...
                case LED_FLAG_KEYLIGHT:
                    ...
                    break;
                default:
                    rgb_matrix_set_flags_noeeprom(LED_FLAG_UNDERGLOW | LED_FLAG_KEYLIGHT);
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        RM_TOGG, KC_ESC,  KC_EQL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,        EE_CLR,  KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSLS, KC_DEL,
        KC_HOME,          KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,        KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
        KC_END,           KC_LGUI, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          RM_TEST,
    ...
    [_FN] = LAYOUT(
        RM_TOGG, KC_GRV,  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_INS,
        CD_HOME,          _______, LOGOUT,  _______, _______, _______, _______,     _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, _______,
        _______,          KC_CAPS, _______, _______, _______, _______, _______,     _______, KC_4,    KC_5,    KC_6,    KC_COLN, KC_GRV,           EE_CLR,
        _______,          _______, REDO,    _______, _______, _______, EE_CLR,      _______, KC_1,    KC_2,    KC_3,    KC_QUES, _______, _______,
