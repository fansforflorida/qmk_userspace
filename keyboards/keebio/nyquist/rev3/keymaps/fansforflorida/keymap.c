...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ortho_5x12(
        ...
        KC_ESC,  KC_LCTL, KC_LGUI, KC_LALT, MO(2),  SPC_FN4,  KC_SPC,  MO(3),   KC_UP,   KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_ortho_5x12(
    ...
    [3] = LAYOUT_ortho_5x12(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_7,    KC_8,    KC_9,    _______, KC_INS,
        TG(1),   _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    _______, _______,
    ...
    [4] = LAYOUT_ortho_5x12(
        ...
        _______, _______, _______, _______, _______, _______, _______, S(KC_9),    S(KC_0),    KC_BSLS, S(KC_BSLS), _______,
